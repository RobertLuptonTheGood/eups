...
want to consider using \texttt{--no-server-tags} (equivalent to \texttt{-U}) to avoid this; the specified
...
You can list tags with e.g. \texttt{eups distrib tags w\_2017*} (note the glob; csh users in particular
...
if you specify \texttt{eups distrib list --precise} (or \texttt{--verbose} --- but that'll also
