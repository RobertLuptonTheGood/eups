...
Options:
   ...
   -N, --noeups          Don't loopup product in eups when creating a distribution
...
rsync -rv /Users/rhl/NewACT/products/packages apache2:/u/act/WWW/public

eups distrib -v -i --current moby --root http://www.astro.princeton.edu/~act/packages/build
\end{verbatim}
...
and everyone's happy.\footnote{
  N.b. \code{eups distrib} is responsible for setting up products
  for you, so if you source the build script by hand you'll first
  have to issue appropriate setup commands by hand.}
  }
  \footnote{
