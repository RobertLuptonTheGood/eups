...
\textbf{N.b. \texttt{PRODUCTS} is going to be retired, and  \texttt{\$PROD\_DIR\_PREFIX} is
going to be renamed  \texttt{\$EUPS\_PATH}.}
...
variable \texttt{PROD\_DIR\_PREFIX/ups\_db} (or the \texttt{-z} or \texttt{-Z} option).
