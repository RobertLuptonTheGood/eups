...
\end{verbatim} %$
If you have defined \code{\$EUPS\_PATH}, it'll be used as the default
value instead of \code{/usr/local/share}.
...
\end{verbatim}
\code{EUPS\_PATH=...} also works as an alternative to \code{--with-ups=...};
note upper case.
