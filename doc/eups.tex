...
The flavor is usually determined by the value of \code{\$EUPS\_DIR/bin/eups\_flavor},
...
Options:
	...
	-d  --directory Print product directory to stderr
        -f, --flavor    Use this flavor (default: $EUPS_FLAVOR)
  ...
  \item{\code{AC\_DEFINE\_ROOT(version [, flavor])}}
    ...
    \begin{itemize}
      ...
      \item{\code{--with-flavor=XXX}}
        ...
        (default: flavor, or, failing that, the value of eups\_flavor and, failing \textbf{that},uname).
    \end{itemize}
\end{itemize}
