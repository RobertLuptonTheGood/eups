...
package directory to another machine and use \code{eups\_distrib -i} to
recreate a working \eups{} installation.

\begin{verbatim}
eups_distrib -v -z act -c pslib RHL_v1_1
./configure --with-eups=/u/rhl/ppp; make install
eups_distrib -Z /u/rhl/ppp -v -z rhl -i -r /u/act/products/packages pslib RHL_v1_1
\end{verbatim}

When installing (\code{-i}) the package root may be specified as a URL, e.g.
